...
const { appState ,addBoard, closeCreateModule, setAppState } = useContext(AppState);

  const handleSubmit = (e) => {
    e.preventDefault();
    // call addBoard function from App.jsx
    // pass title and columns as arguments from state
  ...
  return(
    ...
    <form className="form">
      ...
      <div className="form__btns">
        <button onClick={handleAddColumn} className="secondary-btn btn create-column">+ Add New Column</button>
        <button onClick={handleSubmit} className="primary-btn btn create-board">Save Changes</button>
      </div>
    </form>
  </section>
  )
